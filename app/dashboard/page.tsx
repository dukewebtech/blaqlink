          ...
          {userStoreId && storeUrl && userProfile?.admin_kyc_approved && (
            <div className="flex items-center gap-2 min-w-0">
              <a
                ...
                className="text-sm text-primary hover:underline font-medium truncate max-w-[180px] sm:max-w-xs"
                title={storeUrl}
              >
                {storeUrl}
              </a>
              <Button onClick={copyToClipboard} variant="outline" size="sm" className="gap-2 bg-transparent shrink-0">
