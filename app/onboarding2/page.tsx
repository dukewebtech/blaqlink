...
import { StoreSetupStep } from "@/components/onboarding/store-setup-step-v2"
...
export default function OnboardingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background to-muted/30">
      <div className="container mx-auto px-4 py-10 max-w-lg motion-safe:animate-in motion-safe:fade-in motion-safe:duration-500">
        {/* Brand */}
