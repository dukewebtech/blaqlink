  ...
  return (
    <DashboardLayout>
      <div className="flex flex-col gap-6">
        {/* Header */}
        <div>
          <h1 className="text-xl sm:text-2xl font-semibold text-foreground">Payouts</h1>
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex gap-2">
            <Button variant="outline" className="gap-2 bg-transparent flex-1 sm:flex-none" onClick={() => router.push("/settings/payout")}>
              <Wallet className="size-4" />
              Bank Settings
            </Button>
            <Button className="gap-2 flex-1 sm:flex-none" onClick={() => setShowRequestModal(true)}>
              Request Withdrawal
            </Button>
          </div>
        </div>
                  ...
                  >
                    <div className="flex items-center gap-3 min-w-0">
                      ...
                      <div className="min-w-0">
                        <p className="font-medium truncate">{withdrawal.bank_name}</p>
                    ...
                    <div className="flex items-center justify-between sm:justify-end sm:flex-col sm:items-end gap-2 sm:gap-1 shrink-0">
                      ...
                      <div className="flex items-center gap-2">
                        {withdrawal.admin_notes && (
                          <p className="text-xs text-muted-foreground">{withdrawal.admin_notes}</p>
                        )}
