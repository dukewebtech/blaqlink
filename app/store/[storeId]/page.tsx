  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between text-sm">
            <span>📍 {storeInfo.location || "Worldwide Shipping"}</span>
            <span className="hidden md:block">✨ Welcome to {storeInfo.business_name || storeInfo.full_name}</span>
      ...
      <div className="container mx-auto px-4 py-8">
          ...
          <section className="mb-12">
            ...
            <div className="grid grid-cols-3 md:grid-cols-6 gap-4">
              {categories.slice(0, 6).map((category, index) => (
                <Card
                  key={category.id}
                  className={`group p-4 hover:shadow-lg transition-all duration-300 animate-in fade-in zoom-in-95 cursor-pointer ${
        ...
        <section>
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-2xl font-bold">{selectedCategory ? `${selectedCategory} Products` : "All Products"}</h2>
      ...
      <footer className="border-t bg-muted/30 mt-16 py-12">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <h3 className="font-bold text-lg mb-4">{storeInfo.business_name || storeInfo.full_name}</h3>
