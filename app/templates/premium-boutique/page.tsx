...
import { Search, Heart, ShoppingCart, Menu, Star, ArrowRight, X } from "lucide-react"
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="py-12 animate-in fade-in-0 slide-in-from-bottom-4 duration-700 delay-300">
          <div className="grid grid-cols-2 sm:grid-cols-3 md:flex md:justify-center gap-6 md:gap-8">
            {[
              { name: "Dresses", image: "https://ladybiba.com/cdn/shop/files/LB.-24.jpg" },
              {
                name: "Tops",
                image: "https://ladybiba.com/cdn/shop/files/LB.-32_bcde5c2c-2ff0-4eb0-b753-aaf55fc4b2c0.jpg",
              },
              { name: "Bottoms", image: "https://ladybiba.com/cdn/shop/files/LB.-4.jpg" },
              { name: "Outerwear", image: "https://ladybiba.com/cdn/shop/files/adesuablack.jpg" },
              {
                name: "Accessories",
                image: "https://ladybiba.com/cdn/shop/files/27267E8F-B585-4BC2-A0B1-C0FBD7F8CA66.jpg",
              },
              { name: "Shoes", image: "https://ladybiba.com/cdn/shop/files/6E30F2B3-FA51-4AD7-9249-647DB4ADC975.jpg" },
            ].map((category, i) => (
              <div
                key={category.name}
