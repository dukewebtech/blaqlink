  ...
  return (
    <div className="flex h-screen overflow-hidden bg-gradient-to-br from-red-50 via-white to-red-50">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        <header className="flex h-16 items-center justify-between border-b bg-white px-4 sm:px-6 shadow-sm gap-3">
          ...
          {/* Mobile: show page brand */}
          <div className="flex-1 sm:hidden">
            <p className="font-semibold text-red-900">Admin Panel</p>
          </div>
