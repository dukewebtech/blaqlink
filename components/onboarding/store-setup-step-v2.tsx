...
const SECTIONS = ["Business Basics", "Category & Location", "Branding"]
...
export function StoreSetupStep({ prefillName = "", onComplete }: Props) {
  ...
  return (
    <Card className="p-8 motion-safe:animate-in motion-safe:fade-in motion-safe:slide-in-from-bottom-4 motion-safe:duration-500">
      {/* Header */}
      <div className="mb-2">
      ...
      <StepProgress steps={SECTIONS} current={currentSection} />

      <form onSubmit={handleSubmit} className="space-y-8">
        {/* Section 1 — Business Basics */}
        <ScrollReveal onReveal={() => setCurrentSection((c) => Math.max(c, 0))}>
          <div className="space-y-5">
            <p className="text-xs font-semibold text-foreground/70">Business Basics</p>
        ...
        <ScrollReveal delay={80} onReveal={() => setCurrentSection((c) => Math.max(c, 1))}>
          <div className="space-y-5">
            <p className="text-xs font-semibold text-foreground/70">Category &amp; Location</p>
        ...
        {/* Section 3 — Branding */}
        <ScrollReveal delay={160} onReveal={() => setCurrentSection((c) => Math.max(c, 2))}>
          <div className="space-y-5">
            <p className="text-xs font-semibold text-foreground/70">Branding</p>
