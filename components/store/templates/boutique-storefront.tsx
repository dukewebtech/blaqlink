...
export function BoutiqueStorefront({ store, items }: { store: DaylightStore; items: DaylightItem[] }) {
  ...
  return (
    <div className="boutique-store" style={{ ["--accent" as any]: store.accent }}>
      <DaylightIconSprite />
      <BoutiqueIconSprite />
                    ...
                    <>
                      ...
                      <div className="field-row">
                        ...
                        <div className={`field${fieldErrors.city ? " is-bad" : ""}`}>
                          ...
                          <select id="bt-c-city" autoComplete="address-level2" value={order.addressCity} disabled={!order.addressState} onChange={(e) => setOrder((o) => ({ ...o, addressCity: e.target.value }))}>
