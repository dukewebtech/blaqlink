...
export function createPreviewStore(overrides: Partial<DaylightStore> = {}): DaylightStore {
  return {
    ...
    email: "hello@queenchic.com",
    ordersDelivered: 412,
    memberSinceYear: 2023,
    verified: true,
    deliveryAreas: [
      { id: "a1", name: "Lagos mainland", note: "2 to 3 working days", fee: 3000 },
      { id: "a2", name: "Lagos island", note: "1 to 2 working days", fee: 4000 },
      { id: "a3", name: "Other states", note: "3 to 7 working days", fee: 6500 },
    ],
    ...overrides,
  }
}
...
export const PREVIEW_ITEMS: DaylightItem[] = [
  {
  ...
  {
    id: "t1", type: "event", name: "QueenChic Style Night",
