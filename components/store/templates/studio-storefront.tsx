...
export function StudioStorefront({ store, items }: { store: DaylightStore; items: DaylightItem[] }) {
  ...
  return (
    <div className="studio-store" style={{ ["--accent" as any]: store.accent }}>
      <DaylightIconSprite />
      <StudioIconSprite />
                    ...
                    <>
                      ...
                      <div className="field-row">
                        ...
                        <div className={`field${fieldErrors.city ? " is-bad" : ""}`}>
                          ...
                          <select id="st-c-city" autoComplete="address-level2" value={order.addressCity} disabled={!order.addressState} onChange={(e) => setOrder((o) => ({ ...o, addressCity: e.target.value }))}>
